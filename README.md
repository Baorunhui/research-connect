...
具体边界见 [自托管架构](docs/SELF_HOSTING_ARCHITECTURE.md)、[Report Hub 协议](docs/REPORT_HUB_V1.md)、[公网服务器交付说明](docs/PUBLIC_SERVER_HANDOFF.md)、[开发路线](docs/ROADMAP.md) 和 [下一阶段待办](docs/NEXT_SCOPE_TODO.md)。
